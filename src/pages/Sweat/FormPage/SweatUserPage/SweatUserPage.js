...
const SweatUserPage = () => {
    ...
    return(
        <div className='user container'>
            <InputText label="prénom" id="UserFirstName" type={typeList.text} onChange={(e) => {dispatch(setUserFirstName(e))}}/>
            <InputText label="nom" id="UserFirstName" type={typeList.text} onChange={(e) => {dispatch(setUserLastName(e))}}/>
            <InputText label="email" id="UserEmail" type={typeList.email} onChange={(e) => {dispatch(setUserEmail(e))}}/>
            <InputText label="tel" id="UserTel" type={typeList.tel} onChange={(e) => {dispatch(setUserPhone(e))}}/>
